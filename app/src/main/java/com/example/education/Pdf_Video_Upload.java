...
public class Pdf_Video_Upload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categories.add("Cartoons");
        categories.add("KG");
        categories.add("Basic Maths");
...
//        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        ...
        binding.spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                 ...
                 if(course.equals("Select Category")){
                     course="";
                 }
            }
...
//        Toast.makeText(Pdf_Video_Upload.this, course, Toast.LENGTH_SHORT).show();
        ...
        binding.cvUploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(title) && !TextUtils.isEmpty(course)){
                    ...
                    if(requestCode==12){
                        storage.getReference().child("upload").child(timeStamp+auth.getUid()).putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            @Override
